        ...
        <>
            <div className="flex mt-10 w-[50%] gap-14  ">
                ...
                <div className="flex flex-col items-start">
                    <p className="text-4xl font-semibold">Rivansh</p>
                    <p className="text-4xl font-semibold">Srivastava</p>
                ...
                <div className="flex flex-col w-[90%] text-justify gap-4 ">
                    ...
                    <div className="flex flex-col">
                        <p className="font-semibold text-sm">Email: <span className="font-regular">rivansh63@gmail.com</span></p>
